...
float grid::ComputeTimeStep()
{
  ...
  if (NumberOfBaryonFields > 0 && (HydroMethod != HD_RK) && (HydroMethod != MHD_RK)) {
    ...
    int DensNum, GENum, TENum, Vel1Num, Vel2Num, Vel3Num, 
        B1Num, B2Num, B3Num, CRENum, CRF1Num, CRF2Num, CRF3Num;
    this->IdentifyPhysicalQuantities(DensNum, GENum, Vel1Num, Vel2Num, Vel3Num, 
                                     TENum, B1Num, B2Num, B3Num, CRENum, CRF1Num, CRF2Num, CRF3Num); 
  ...
  if (NumberOfBaryonFields > 0 && HydroMethod == MHD_RK) {
    ...
    int DensNum, GENum, TENum, Vel1Num, Vel2Num, Vel3Num, 
      B1Num, B2Num, B3Num, PhiNum, CRENum;
    if (this->IdentifyPhysicalQuantities(DensNum, GENum, Vel1Num, Vel2Num, 
    ...
    if (CRModel==1)
      Pcr = (CRgamma - 1.0) * BaryonField[CRENum][n];
